...
class BrandReferenceTests(unittest.TestCase):
    ...
    def test_reference_is_repository_owned_and_linked(self) -> None:
        ...
        self.assertIn('public-interface-footer-extension-v1.json', footer)
