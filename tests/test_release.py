...
class ReleaseArtifactTests(unittest.TestCase):
    def test_release_archive_is_deterministic_and_contains_contract_files(self) -> None:
        ...
        prefix = 'atlas-interface-kit-0.4.0'
        for path in ('dist/manifest.json', 'dist/semantics.json', 'docs/BRAND_REFERENCE.md', 'docs/CONSUMER_CONTRACT.md', 'docs/FOUNDATION_EXTENSION.md', 'docs/FOOTER_EXTENSION.md', 'release-manifest.json'):
