...
RELEASE_MEMBERS = (
    ...
    "docs/FOUNDATION_EXTENSION.md",
    "docs/FOOTER_EXTENSION.md",
    "docs/EVIDENCE_MODE_EXTENSION.md",
...
def main() -> int:
    ...
    print(json.dumps(build_release(args.output_dir, validate=not args.skip_validation), indent=2, sort_keys=True))
    return 0
