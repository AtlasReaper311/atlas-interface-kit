...
def main() -> int:
    ...
    if authority.get('footer_extension_version') != FOOTER_EXTENSION_VERSION:
        raise SystemExit('semantic footer extension version does not match build contract')
